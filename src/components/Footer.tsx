            ...
            {Object.entries(socialLinks).map(([platform, url]) => (
              <li key={platform}>
                <a 
                  ...
                  className="text-gray-600 hover:text-primary-600 transition-colors capitalize"
                >
                  {platform}
                </a>
              </li>
          ...
          return (
            <ul className="space-y-2 text-sm">
              {section.customLinks.map((link: any) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-gray-600 hover:text-primary-600 transition-colors">
                    {link.name}
                  </Link>
                </li>
              ))}
