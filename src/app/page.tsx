            ...
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300 h-full">
              ...
              <div className="p-8 lg:p-10">
                ...
                <h2 className="text-3xl lg:text-4xl font-bold mb-6 leading-tight">
                  <Link href={`/${featuredPost.slug}`} className={`${uiColors.cardTitle} hover:${uiColors.cardTitleHover} transition-colors duration-200`}>
                    {featuredPost.title}
                  </Link>
                </h2>
                ...
                <Link
                  ...
                  className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary-600 to-secondary-600 text-white font-semibold rounded-full hover:from-primary-700 hover:to-secondary-700 transition-all duration-200 shadow-lg hover:shadow-xl"
                >
                  Read More
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <h4 className="text-lg font-semibold mb-2 line-clamp-2">
                          <Link href={`/${post.slug}`} className={`${uiColors.cardTitle} group-hover:${uiColors.cardTitleHover} transition-colors duration-200`}>
                            {post.title}
                          </Link>
                        </h4>
