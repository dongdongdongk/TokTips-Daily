...
export default async function PostPage({ params }: PostPageProps) {
  ...
  return (
    ...
    <article className="w-full mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-center">
            <div className="flex flex-wrap gap-3 justify-center">
              {post.tags?.map(tag => (
                <span
                  key={tag}
                  className="px-4 py-2 text-sm font-medium text-primary-600 bg-gradient-to-r from-primary-50 to-secondary-50 rounded-full border border-primary-200 hover:from-primary-100 hover:to-secondary-100 transition-all duration-200"
                >
                  {tag}
                </span>
              ))}
          ...
          {post.author && (
            <div className="text-center">
              <div className="inline-flex items-center text-gray-600 bg-gray-50 px-4 py-2 rounded-full">
                <div className="w-6 h-6 bg-gradient-to-br from-primary-500 to-secondary-500 rounded-full mr-3 flex items-center justify-center">
      ...
      <div 
        className="blog-content prose prose-base lg:prose-lg max-w-3xl mx-auto prose-headings:font-bold prose-headings:text-gray-900 prose-p:text-gray-700 prose-p:leading-relaxed prose-a:text-primary-600 prose-a:font-medium prose-a:no-underline hover:prose-a:underline prose-strong:text-gray-900 prose-code:bg-gray-100 prose-code:text-gray-800 prose-code:px-2 prose-code:py-1 prose-code:rounded prose-pre:bg-gray-50 prose-pre:border prose-pre:border-gray-200 prose-blockquote:border-l-4 prose-blockquote:border-primary-500 prose-blockquote:bg-primary-50 prose-blockquote:pl-6 prose-img:rounded-xl prose-img:shadow-lg"
        dangerouslySetInnerHTML={{ __html: post.htmlContent }}
      />
      
      <footer className="mt-16 pt-12">
        <div className="max-w-3xl mx-auto bg-gradient-to-br from-primary-50 to-secondary-50 p-8 rounded-3xl border border-primary-100">
          <div className="text-center">
        ...
        <div className="mt-12 text-center">
          <Link 
            href="/" 
            className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-primary-600 to-secondary-600 text-white font-semibold rounded-full hover:from-primary-700 hover:to-secondary-700 transition-all duration-200 shadow-lg hover:shadow-xl"
          >
